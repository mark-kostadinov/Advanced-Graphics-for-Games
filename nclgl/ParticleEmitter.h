...
#include "HeightMap.h"
#include "../Game Engine/Game Engine/definitions.h"
#include <vector>
...
public:
	...
	*/
	...
	Vector3 GetEmitterPosition() const { return emitterPosition; }
	void SetEmitterPosition(Vector3 pos) { emitterPosition = pos; }
